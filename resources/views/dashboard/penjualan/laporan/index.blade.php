    ...
    <div class="container-fluid mt-3">
        <div class="card shadow-sm border-0">
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('laporan.penjualan.index') }}" class="row mb-4">
                    <div class="col-md-4">
                        <label for="tgl_pembelian">Tanggal Penjualan</label>
                        <input type="date" name="tgl_penjualan" id="tgl_pembelian" class="form-control"
                            value="{{ request('tgl_penjualan') }}">
                    </div>
        ...
        <div class="card shadow-sm border-0 my-2">
            <div class="card-body">
                <h5 class="mb-4"><i class="mdi mdi-table-large"></i> Daftar Penjualan Obat</h5>
                            ...
                            @foreach ($laporans as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a target="_blank"
                                            href="{{ route('laporan.penjualan.print', ['id' => $item->order_id]) }}"
                                            class="btn btn-sm btn-warning"><i class="mdi mdi-printer"></i>Print</a>
                                        <form action="{{ route('penjualan.destroy', ['id' => $item->order_id]) }}"
