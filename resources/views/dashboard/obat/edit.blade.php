                ...
                <form action="{{ route('obat.update', $obat->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <select name="id_jenis" id="id_jenis" class="form-control @error('id_jenis') is-invalid @enderror"
                            ...
                            @foreach ($jenisObat as $jenis)
                                <option value="{{ $jenis->id }}"
                                    {{ old('id_jenis', $obat->id_jenis) == $jenis->id ? 'selected' : '' }}>
                                    {{ $jenis->jenis }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('harga_jual') is-invalid @enderror" id="harga_jual"
                            name="harga_jual" value="{{ old('harga_jual', $obat->harga_jual) }}" required>
                        @error('harga_jual')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('deskripsi_obat') is-invalid @enderror" id="deskripsi_obat" name="deskripsi_obat"
                            rows="4" required>{{ old('deskripsi_obat', $obat->deskripsi_obat) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ asset('storage/' . $obat->foto1) }}" alt="Foto 1" class="mt-2" width="150">
                        @error('foto1')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ asset('storage/' . $obat->foto2) }}" alt="Foto 2" class="mt-2" width="150">
                        @error('foto2')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ asset('storage/' . $obat->foto3) }}" alt="Foto 3" class="mt-2" width="150">
                        @error('foto3')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
